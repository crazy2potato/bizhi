package com.tudou.tudoupicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // tudou_picture.picture_112321321,tudou_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "tudou_picture." + tableName) // 确保前缀合法
